...
* [ ] Make a platformer in go (see pixel lib), put it on github
...
* [ ] Build a small WebBrowser, put it on github
* [ ] Make a small Machine learning library in java,  put it on github
* [ ] Make an application for using it with Scene builder,  put it on github
    * Load a dataset
    * Choose the method
