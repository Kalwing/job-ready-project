...
Here you'll learn programming, and how to present your work. You'll improve most of your projects if you find a way of putting them on the web. Even if you don't want to be a web developer, do not skip this tier.
...
* [ ] **P1XT** Do [Must Do Coding Questions Company-wise](https://www.geeksforgeeks.org/must-coding-questions-company-wise/) for Microsoft
...
* [ ] **P1XT** Complete the [Hackerrank Probability Challenges](https://www.hackerrank.com/domains/mathematics/probability)   
* [ ] **P1XT** Complete the [Hackerrank Linear Algebra Foundations Challenges](https://www.hackerrank.com/domains/mathematics/linear-algebra-foundations)
* [ ] **P1XT** Complete one competition of your choice from [Crowd Analytix](https://www.crowdanalytix.com/community)
* [ ] **P1XT** Complete one competition of your choice from [Driven Data](https://www.drivendata.org/competitions/)
...
* [ ] **P1XT** [Thinks Bayes](http://www.greenteapress.com/thinkbayes/thinkbayes.pdf)
* [ ] [Model thinking](https://www.coursera.org/learn/model-thinking)
* [ ] [Advanced algorithms specialization](https://github.com/P1xt/p1xt-guides/blob/master/specializations/advanced-algorithms.md)
* [ ] [Data science II](https://github.com/P1xt/p1xt-guides/blob/master/specializations/data-science-ii.md)
* [ ] **P1XT** [Google Code Jam](https://codingcompetitions.withgoogle.com/codejam/archive) year of your choice (that you haven't previously completed)
* [ ] **P1XT** Do [Must Do Coding Questions Company-wise](https://www.geeksforgeeks.org/must-coding-questions-company-wise/) for an additional company of your choice
* [ ] **P1XT** [Facebook Hacker Cup](https://www.facebook.com/hackercup/past_rounds/228440181128818/) year of your choice (that you haven't previously completed)
